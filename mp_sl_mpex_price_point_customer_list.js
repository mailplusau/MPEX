 ...
 * @Last Modified time: 2020-08-07 13:29:35
 *
 */
...
function main(request, response) {
  ...
  if (request.getMethod() == "GET") {
    ...
    inlineHtml += '<br><br><table border="0" cellpadding="15" id="customer" class="display tablesorter table table-striped table-bordered table-responsive" cellspacing="0"><thead style="color: white;background-color: #607799;"><tr><th class="text-center">ID</th><th class="text-center">Customer</th><th class="text-center">New Rates - Date Scheduled</th><th class="text-center" colspan=2>5Kg </th><th class="text-center" colspan=2>3Kg</th><th  class="text-center" colspan=2>1Kg</th><th class="text-center" colspan=2>500g</th><th class="text-center" colspan=2>B4</th><th class="text-center" colspan=2>C5</th><th class="text-center" colspan=2>DL</th></tr><tr><th class="text-center"></th><th class="text-center"></th><th class="text-center"></th><th class="text-center">Current</th><th class="text-center">Scheduled</th><th class="text-center">Current</th><th class="text-center">Scheduled</th><th class="text-center">Current</th><th class="text-center">Scheduled</th><th class="text-center">Cuurent</th></th><th class="text-center">Scheduled</th><th class="text-center">Current</th><th  class="text-center">Scheduled</th><th class="text-center">Current</th><th class="text-center">Scheduled</th><th class="text-center">Current</th><th class="text-center">Scheduled</th></tr></thead>';
