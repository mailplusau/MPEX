 ...
 * @Last Modified time: 2021-09-02 13:02:50
 *
 */
...
function main() {
    ...
    resultCreateProdOrder.forEachResult(function(searchResult) {
        ...
        nlapiLogExecution('DEBUG', 'single_pro_gold_toll', single_pro_gold_toll);
        nlapiLogExecution('DEBUG', 'single_pro_gold_mp', single_pro_gold_mp);
