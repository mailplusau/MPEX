...
function main() {
  ...
  resultCreateProdOrder.forEachResult(function (searchResult) {
    ...
    var cust_prod_date_lodged = searchResult.getValue(
    ...
    var mpex_5kg_price_point = parseInt(
    ...
    var mpex_3kg_price_point = parseInt(
      searchResult.getValue(
    ...
    var mpex_1kg_price_point = parseInt(
      searchResult.getValue(
    ...
    var mpex_500g_price_point = parseInt(
      searchResult.getValue(
    ...
    var mpex_B4_price_point = parseInt(
      searchResult.getValue(
    ...
    var mpex_C5_price_point = parseInt(
      searchResult.getValue(
    ...
    var mpex_DL_price_point = parseInt(
      searchResult.getValue(
    ...
    //Sender Details
    var senderSuburb = searchResult.getValue("custrecord_sender_suburb");
    var senderPostcode = searchResult.getValue("custrecord_sender_post_code");
    var senderState = searchResult.getValue("custrecord_sender_state");
    ...
    var cust_prod_pricing_dl_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_dl",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_c5_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_c5",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_b4_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_b4",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_250g_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_250g",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_500g_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_500g",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_1kg_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_1kg",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_3kg_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_3kg",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_5kg_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_5kg",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_10kg_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_10kg",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );
    var cust_prod_pricing_25kg_ns_item = searchResult.getValue(
      "custrecord_prod_pricing_25kg",
      "CUSTRECORD_CUST_PROD_PRICING",
      null
    );

    if (!isNullorEmpty(cust_prod_date_stock_used)) {
      var z1 = cust_prod_date_stock_used.split("/");
    } else {
      var z1 = cust_prod_date_lodged.split("/");
    }
    ...
    if (cust_prod_customer != old_customer_id) {
      ...
      if (count != 0) {
        ...
        nlapiLogExecution(
          "AUDIT",
          "manualBarcodesCount before saving",
          manualBarcodesCount
        );
        ...
        productOrderRec.setFieldValue(
          "custrecord_manual_barcode_count",
          manualBarcodesCount
        );
      ...
      if (
        (barcode_source == 1 || isNullorEmpty(barcode_source)) &&
        manualFeeToBeCharged != 2
      ) {
        manualBarcodesCount++;
      }
      ...
      if (
        tgeReceiverTempLevyApplicable == true ||
        tgeSenderTempLevyApplicable == true
      ) {
      ...
      if (count > 450) {
        ...
        nlapiLogExecution(
          "AUDIT",
          "manualBarcodesCount saving once count crossed 450",
          manualBarcodesCount
        );
  ...
  if (count > 0) {
    ...
    nlapiLogExecution(
      "AUDIT",
      "manualBarcodesCount saving at the last loop",
      manualBarcodesCount
    );
