 ...
 * @Last Modified time: 2021-09-15 16:46:04
 *
 */
...
function main(request, response) {
  ...
  if (request.getMethod() == "GET") {
    ...
    inlineHtml += '</br>If you choose to change a rate, you must make and save your changes before <b>midnight Oct 4 2021</b>. Otherwise, the new rate scheduled below will automatically apply - no further action required.</div>';
