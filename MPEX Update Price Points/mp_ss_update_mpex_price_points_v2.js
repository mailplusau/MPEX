...
function updateMPEXCurrentPricePoints() {
     ...
     */
    var mpexPricingCustomerList = nlapiLoadSearch('customer', 'customsearch_mpex_price_point_customer_7');
    ...
    resultSetMpexPricing.forEachResult(function(searchResult) {
        ...
        customer_record.setFieldValue('custentity_mpex_1kg_price_point', mpex_1kg_new);
        customer_record.setFieldValue('custentity_mpex_3kg_price_point', mpex_3kg_new);
        customer_record.setFieldValue('custentity_mpex_5kg_price_point', mpex_5kg_new);
        customer_record.setFieldValue('custentity_mpex_500g_price_point', mpex_500g_new);
