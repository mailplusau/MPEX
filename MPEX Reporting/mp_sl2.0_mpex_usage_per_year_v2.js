		...
		function onRequest(context) {
			...
			if (context.request.method === 'GET') {
				...
				if (isNullorEmpty(context.request.parameters.zee)) {
					...
					var form = ui.createForm({
						title: zee_name + 'MPEX Yearly Usage'
					});
				}
				...
				form.addButton({
					id: 'adhoc_new_customers',
					label: 'Adhoc / New Customers',
					functionName: 'adhocNewCustomers()'
				});
				...
				form.clientScriptFileId = 4976585;
