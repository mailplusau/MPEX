        ...
        function loadDatatable(debt_rows) {
            ...
            if (!isNullorEmpty(debt_rows)) {
                debt_rows.forEach(function(debt_row, index) {
                    ...
                    var detailedInvoiceURLMonth = '<a href="https://1048144.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1285&deploy=1&zee=' + zee + '&start_date=' + startDate + '&last_date=' + lastDate + '" target=_blank>VIEW (per week)</a> | <a href="https://1048144.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1287&deploy=1&zee=' + zee + '&start_date=' + startDate + '&last_date=' + lastDate + '" target=_blank>VIEW (per day)</a> | <a href="https://1048144.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1276&deploy=1&zee=' + zee + '&start_date=' + startDate + '&last_date=' + lastDate + '" target=_blank>VIEW (Product Types)</a> | <a href="https://1048144.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1290&deploy=1&zee=' + zee + '&start_date=' + startDate + '&last_date=' + lastDate + '" target=_blank>VIEW (Customer & Franchisee Count)</a>';


                    debtDataSet.push([detailedInvoiceURLMonth, month, debt_row.source_manual, debt_row.source_shopify, debt_row.source_portal,debt_row.source_bulk, debt_row.total_usage]);
                    csvSet.push([month, debt_row.source_manual, debt_row.source_shopify, debt_row.source_portal,debt_row.source_bulk, debt_row.total_usage]);
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                sourcePortal[data[i][1]] = data[i][4]; //creating array for storing browser type in array.
                sourceBulk[data[i][1]] = data[i][5]; //creating array for storing browser type in array.
                sourceShopify[data[i][1]] = data[i][3]; //
