...
define(['N/ui/serverWidget', 'N/email', 'N/runtime', 'N/search', 'N/record', 'N/http', 'N/log', 'N/redirect'],
    function(ui, email, runtime, search, record, http, log, redirect) {
            ...
            if (context.request.method === 'GET') {
                ...
                if (isNullorEmpty(context.request.parameters.custid)) {
                    var form = ui.createForm({
                        title: 'MPEX Monthly Usage per Customer - by Source'
                    });
                } else {
                    ...
                    var form = ui.createForm({
                        title: 'MPEX Monthly Usage per Customer - by Source - ' + company_name
                    });
                }
                ...
                form.clientScriptFileId = 4999030;
        ...
        function dataTable() {
            ...
            // inlineHtml += '<th>Link</th>';
            // inlineHtml += '<th>Month Used</th>';
            // inlineHtml += '<th colspan=2>Manual</th>';
            // inlineHtml += '<th colspan=2>Shopify</th>';
            // inlineHtml += '<th colspan=2>Portal</th>';
            // inlineHtml += '<th colspan=2>Bulk</th>';
