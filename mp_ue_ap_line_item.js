    ...
    if (type == 'edit' || type == 'xedit') {
        ...
        if (!isNullorEmpty(productOrderId)) {
            ...
            if (price_increase_date <= orderDate) {
                ...
                nlapiLogExecution('AUDIT', 'beforeSubmit - edit-franchisee_com ', franchisee_com);
...
function afterSubmit(type, form) {
    if (type == 'create') {
        ...
        nlapiLogExecution('DEBUG', 'apItemId ', isNullorEmpty(apItemId));
        ...
        if (!isNullorEmpty(productOrderId) && isNullorEmpty(stockReceiptId)) {
            ...
            nlapiLogExecution('AUDIT', 'afterSubmit - create - franchisee_com ', franchisee_com);
            if (isNullorEmpty(franchisee_com)) {
                franchisee_com = 0;
            }
